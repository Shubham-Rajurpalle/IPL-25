...
public class FragmentQuizBindingImpl extends FragmentQuizBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.questiontxt, 1);
        sViewsWithIds.put(R.id.optionGroup, 2);
        sViewsWithIds.put(R.id.option1, 3);
        sViewsWithIds.put(R.id.option2, 4);
        sViewsWithIds.put(R.id.option3, 5);
        sViewsWithIds.put(R.id.option4, 6);
    }
    // views
    @NonNull
