...
public class ActivityMemeBindingImpl extends ActivityMemeBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.addMeme, 4);
        sViewsWithIds.put(R.id.backtoMainA, 5);
        sViewsWithIds.put(R.id.listNoPost, 6);
        sViewsWithIds.put(R.id.scrollView2, 7);
        sViewsWithIds.put(R.id.recycleMeme, 8);
    }
    // views
    @NonNull
    ...
    public ActivityMemeBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 9, sIncludes, sViewsWithIds));
    }
    private ActivityMemeBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
